...
int B_PLUS_TREE_LEAF_PAGE_TYPE::Insert(const KeyType &key,
    ...
    // less than the min one, insert in the first one
        ...
        memmove((void*)(array + high + 1), array + high,static_cast<size_t>((GetSize() - high) * sizeof(MappingType)));
...
void B_PLUS_TREE_LEAF_PAGE_TYPE::MoveFirstToEndOf(
    ...
    IncreaseSize(-1);
    memmove((void*)array, array + 1, static_cast<size_t>(GetSize() * sizeof(MappingType)));
